...
### Installation & Launch
1. Download the `Ranlaoshi v1.0.9 Lite.html` file.
2. Double-click the file to open it in your browser.

### First Steps
1. **Create a Course**: Click the `+` button in the course selector.
2. **Add a Lecture**: Click `➕ Add ▾` → `📚 + Lecture` in the sidebar.
3. **Add a Topic**: Click `➕ Add ▾` → `🗂 + Topic`.
4. **Add a Slide**: Click `➕ Add ▾` → `📄 + Slide` and choose a template.
